...
这里收录的是我根据课程讲授、课件、补充材料与整理稿同步的《自然语言处理基础》站内笔记。当前已覆盖课程导论、词义消歧、分类模型与语言模型、分布式语义、HMM 与序列标注，并继续补到短语结构句法分析、依存句法分析、Seq2Seq / Transformer、形式语义、信息检索与预训练语言模型，以及一次 HMM 词性标注实践总结，优先保留适合复习时快速定位主线的版本。PDF 版已更新到覆盖全课程主线的 v7 full 整理稿。
